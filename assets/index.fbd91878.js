import{d as C,y as G,r as l,J as v,a as A,b as u,g as e,o as Y,l as n,c as t,bQ as I,U as Q,x as E,bY as w,bN as P,j as R,_ as q}from"./index.954a2cbc.js";import{M as L}from"./MultiLineResult.0bab4ef4.js";import{g as z,e as M,h,k as S}from"./openpgp.min.ac9ba9ff.js";const D={class:"sign"},N={class:"sign-message"},F={class:"sign-private-key"},k={class:"option"},b=C({__name:"index",setup(B){const{t:a}=G(),f=`-----BEGIN PGP PRIVATE KEY BLOCK-----
...
`,m="passphrase",y="A Free, Modern Toolbox, Built for Developers.",p=l(f),i=l(m),d=l(y),r=l("");v(()=>{c()});async function c(){const V=await z({privateKey:await M({armoredKey:p.value}),passphrase:i.value}),s=await h({text:d.value}),g=await S({message:s,signingKeys:V});r.value=g}return(V,s)=>{const g=R("a-input-password"),K=R("a-space");return Y(),A(e(P),{"max-width":1280},{one:u(()=>[n("div",D,[n("div",N,[t(e(I),{modelValue:d.value,"onUpdate:modelValue":s[0]||(s[0]=o=>d.value=o),title:e(a)("pgp.sign.title.message")},null,8,["modelValue","title"])]),n("div",F,[t(e(I),{modelValue:p.value,"onUpdate:modelValue":s[1]||(s[1]=o=>p.value=o),title:e(a)("pgp.sign.title.private")},null,8,["modelValue","title"])]),n("div",k,[t(K,null,{default:u(()=>[Q(E(e(a)("pgp.sign.title.passphrase"))+" ",1),t(g,{value:i.value,"onUpdate:value":s[2]||(s[2]=o=>i.value=o),type:"password",class:"passphrase-input"},null,8,["value"]),t(e(w),{type:"primary",onClick:c},{default:u(()=>[Q(E(e(a)("pgp.sign.button")),1)]),_:1})]),_:1})]),n("div",null,[t(e(L),{"result-desc":e(a)("pgp.sign.title.result"),result:r.value},null,8,["result-desc","result"])])])]),_:1})}}});const Z=q(b,[["__scopeId","data-v-b7342566"]]);export{Z as default};
