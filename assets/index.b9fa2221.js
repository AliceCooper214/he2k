import{d as x,y as D,J as G,r as u,a as L,b as d,g as e,o as U,l as g,c as s,bQ as m,U as A,x as w,bY as Y,bN as f,j as P,_ as z}from"./index.954a2cbc.js";import{M as V}from"./MultiLineResult.0bab4ef4.js";import{g as q,e as I,_ as b,u as K}from"./openpgp.min.ac9ba9ff.js";const T={class:"decrypt"},v={class:"decrypt-button"},C=x({__name:"index",setup(R){const{t:n}=D(),M=`-----BEGIN PGP MESSAGE-----
...
`,S="passphrase";G(()=>{y()});const r=u(M),l=u(O),c=u(S),E=u("");function y(){Q(r.value,l.value,c.value).then(i=>{E.value=i})}async function Q(i,t,p){let o;try{return p!==""?o=await q({privateKey:await I({armoredKey:t}),passphrase:p}):o=await I({armoredKey:t}),(await b({message:await K({armoredMessage:i}),decryptionKeys:o})).data}catch{return"Decryption failed"}}return(i,t)=>{const p=P("a-input-password"),o=P("a-space");return U(),L(e(f),{"max-width":1280},{one:d(()=>[g("div",T,[g("div",null,[s(e(m),{modelValue:r.value,"onUpdate:modelValue":t[0]||(t[0]=a=>r.value=a),title:e(n)("pgp.decrypt.title.message"),class:"message-input"},null,8,["modelValue","title"]),s(e(m),{modelValue:l.value,"onUpdate:modelValue":t[1]||(t[1]=a=>l.value=a),title:e(n)("pgp.decrypt.title.private")},null,8,["modelValue","title"])]),g("p",v,[s(o,null,{default:d(()=>[A(w(e(n)("pgp.decrypt.title.passphrase"))+" ",1),s(p,{value:c.value,"onUpdate:value":t[2]||(t[2]=a=>c.value=a),type:"password",class:"passphrase-input"},null,8,["value"]),s(e(Y),{type:"primary",onClick:y},{default:d(()=>[A(w(e(n)("pgp.decrypt.button")),1)]),_:1})]),_:1})]),s(e(V),{"result-desc":e(n)("pgp.decrypt.title.result"),result:E.value},null,8,["result-desc","result"])])]),_:1})}}});const N=z(C,[["__scopeId","data-v-6ddfeec7"]]);export{N as default};
