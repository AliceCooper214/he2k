import{d as v,y as E,J as M,r as p,a as w,b as c,g as e,o as A,l as d,c as n,bQ as B,U as y,x as z,bY as I,bN as L,_ as K}from"./index.954a2cbc.js";import{M as g}from"./MultiLineResult.0bab4ef4.js";import{v as N,h as Q,J as G}from"./openpgp.min.ac9ba9ff.js";const Y={class:"encrypt"},x={class:"encrypt-button"},U=v({__name:"index",setup(h){const{t:s}=E();let f="A Free, Modern Toolbox, Built for Developers.";const m=`-----BEGIN PGP PUBLIC KEY BLOCK-----
...
`;M(()=>{i()});const l=p(f),u=p(m),r=p("");function i(){C(l.value,u.value).then(a=>{r.value=a})}async function C(a,t){return await N({message:await Q({text:a}),encryptionKeys:await G({armoredKey:t})})}return(a,t)=>(A(),w(e(L),{"max-width":1280},{one:c(()=>[d("div",Y,[n(e(B),{modelValue:l.value,"onUpdate:modelValue":t[0]||(t[0]=o=>l.value=o),title:e(s)("pgp.encrypt.title.message"),class:"message-input"},null,8,["modelValue","title"]),n(e(B),{modelValue:u.value,"onUpdate:modelValue":t[1]||(t[1]=o=>u.value=o),title:e(s)("pgp.encrypt.title.public")},null,8,["modelValue","title"]),d("p",x,[n(e(I),{type:"primary",onClick:i},{default:c(()=>[y(z(e(s)("pgp.encrypt.button")),1)]),_:1})]),n(e(g),{"result-desc":e(s)("pgp.encrypt.title.encrypted"),result:r.value},null,8,["result-desc","result"])])]),_:1}))}});const T=K(U,[["__scopeId","data-v-b1fab27a"]]);export{T as default};
